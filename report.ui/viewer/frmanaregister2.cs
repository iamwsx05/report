...
namespace Report.Ui
{
    ...
    /// 术后镇痛登记表
    /// </summary>
    public partial class frmAnaRegister2 : frmBaseMdi
    {
        #region 构造
        /// <summary>
        /// 构造
        /// </summary>
        public frmAnaRegister2()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            //EntityAnaRegister2 vo = GetRowObject();
        ...
        void Query()
        {
            ...
            try
            {
                ...
                using (ProxyAnaReport proxy = new ProxyAnaReport())
                {
                    ...
                    this.gcData.DataSource = proxy.Service.GetAnaRegister2(beginDate, endDate);
                }
            }
            finally
            {
        ...
        void EditRegister()
        {
            ...
            {
                frmAnaEdit2 frm = new frmAnaEdit2(vo.AnaId);
                frm.ShowDialog();
                if (frm.IsSave)
                {
                    this.Query();
        ...
        XtraReport GetXR(decimal rptId)
        {
            ...
            xr.DataSource = this.gcData.DataSource as List<EntityAnaRegister2>;
            XRControl xc; //报表上的组件
        ...
        /// </summary>
        /// <returns></returns>
        EntityAnaRegister2 GetRowObject()
        {
            if (this.gvData.FocusedRowHandle < 0) return null;
            return this.gvData.GetRow(this.gvData.FocusedRowHandle) as EntityAnaRegister2;
        }
        #endregion
        ...
        private void frmAnaRegister2_Load(object sender, EventArgs e)
        {
            this.Init();
        }
